...
namespace Dynastream.Fit
{
    ...
    public class MesgDefinition
    {
        ...
        private readonly SortedDictionary<DeveloperDataKey, DeveloperFieldDefinition> _devFieldDefs =
            new SortedDictionary<DeveloperDataKey, DeveloperFieldDefinition>();
        private byte header;
        #endregion
        ...
        {
            get { return (byte)_devFieldDefs.Count; }
        }
        ...
        public MesgDefinition(Mesg mesg)
        {
            ...
            {
                var key = new DeveloperDataKey(field.DeveloperDataIndex, field.Num);
                _devFieldDefs[key] = new DeveloperFieldDefinition(
                    field.Num,
                    field.GetSize(),
        ...
        public MesgDefinition(MesgDefinition mesgDef)
        {
            ...
            foreach (var fieldDefPair in mesgDef._devFieldDefs)
            {
                _devFieldDefs[fieldDefPair.Key] = fieldDefPair.Value;
            }
        ...
        public void Write(Stream fitDest)
        {
            ...
            foreach (DeveloperFieldDefinition def in _devFieldDefs.Values)
            {
        ...
        public int GetMesgSize()
        {
            ...
            mesgSize += _devFieldDefs.Sum(x => x.Value.Size);
        ...
        {
            DeveloperDataKey key = new DeveloperDataKey(developerIndex, num);

            return _devFieldDefs.ContainsKey(key) ? _devFieldDefs[key] : null;
        }
