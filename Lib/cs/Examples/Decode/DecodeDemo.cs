...
namespace DecodeDemo
{
    class Program
    {
            ...
            try
            {
                ...
                else
                {
                    try
                    {
                        ...
                        if (decodeDemo.InvalidDataSize == true)
                        {
                        ...
                        else
                        {
                            ...
                            decodeDemo.Read(fitSource, true);
                        }
                    }
        ...
        private static void OnRecordMessage(object sender, MesgEventArgs e)
        {
            ...
            Console.WriteLine("\tHeartRate {0}", recordMessage.GetHeartRate());
            Console.WriteLine("\tCadence {0}", recordMessage.GetCadence());
            Console.WriteLine("\tSpeed {0}", recordMessage.GetSpeed());
            Console.WriteLine("\tDistance {0}", recordMessage.GetDistance());
